              ...
              <div className="flex items-center justify-between">
                ...
                <Drawer>
                  ...
                  <div className="flex flex-row gap-2 w-full px-4 pb-5 justify-end">
                    <Button className="mt-2 w-full sm:w-auto" variant="outline">Cancelar</Button>
                    <Button className="mt-2 w-full sm:w-auto bg-cyan-800" variant="default">Salvar</Button>
                  </div>
                </DrawerContent>
                </Drawer>
              </div>
